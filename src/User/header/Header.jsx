      ...
      <>
        <div className="bg-gray-100 py-3">
          <div className="container mx-auto flex justify-between items-center">
            ...
            <div className="text-black mx-7">
              <img className="w-[100px]" src="/src/img/icon2.png" alt="" />
            </div>
        ...
        <div className=" flex justify-center items-center">
            ...
            <div className="flex">
              ...
              <a href="#" className="anger"><FaHeart className="w-8 text-green-600 hover:text-black" /></a>
              </Link>
              <span className="mx-2 text-green-600">|</span>
              <Link to={'cart'}>
              <a href="#" className="anger"><FaCartShopping className="w-8 text-green-600 hover:text-black"/></a>
              </Link>
              <span className="mx-2 text-green-600">|</span>
        <Dropdown/>
