...
function Offers() {
  return (
    <div className='mx-7 flex gap-8 justify-center'>
        <div className='flex bg-orange-200 w-[500px] rounded-md pt-8' >
            <div className='mx-7 mb-7 mt-28 '>
            <button className='bg-green-500 px-5 py-2 text-white rounded-lg'>25% OFF</button>
 ...
 <div className=''>
    <div className='flex bg-green-200 w-[500px] rounded-md pt-8 ' >
            <div className='mx-7'>
            <button className='bg-green-500 px-3 py-1 text-white rounded-lg'>25% OFF</button>
