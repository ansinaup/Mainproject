...
function HotOffers() {
  return (
    ...
    <div className='  bg-blue-100 flex items-center  rounded-lg   justify-around   ' >
        <div className='font-mono '>
            ...
            <button className="text-white text-m font-bold font-mono bg-green-900 flex rounded-sm mb-11 px-5 py-2" >Place An Order Now
